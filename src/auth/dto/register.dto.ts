...
export class RegisterDto {
  ...
  @IsNotEmpty({message: "El apellido es obligatorio"})
    ...
    @MaxLength(20,{message: "El apellido debe tener como maximo 20 caracteres"})
  apellido: string;
    ...
    @Matches(/^[a-zA-Z0-9_]+$/, { message: "El email solo puede contener letras, números y guiones bajos" })
  correo: string;
  ...
  nombreUsuario: string;
    ...
    @Matches(/^(?=.*[A-Z])(?=.*\d)[a-zA-Z0-9_]{8,}$/, { message: "La contraseña debe contener al menos 8 caracteres, una mayúscula y un número." })
    password: string;
